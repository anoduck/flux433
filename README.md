...
The purpose of this project is the creation of a repository of decoded rtl_433 captures, documenting when they were captured, how many times they were seen, and provide a means to identify unidentified captures. If it just helps to clear space from my hard drive, I will be satisfied.

The next release will probably move the project more towards running as a system service in the background, importing json files exported from rtl_433 in `/var/lib/flux433`, and removing those files once successfully processed into influxdb. Another planned feature is a continual query that will work towards removal of duplicate entries, while increasing the county of how many times the capture was seen.
